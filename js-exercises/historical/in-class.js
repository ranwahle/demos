...
// loadFile(URL, onAncestryData, onLoadError);
...
function onLoadError(message) {
    console.error(`Load file failed [url=${URL}] [err=${message}]`);
}

function onWindowError(err) {
    err.preventDefault();
    console.error(`This is unexpected [err=${err.message}]`);
}
